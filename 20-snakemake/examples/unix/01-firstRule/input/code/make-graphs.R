...
# ggsave does not support Snakemake's create folder function for reasons
...
# save the plots
ggsave("first-stage.png", first_stage, path = out_path)
ggsave("second-stage.png", second_stage, path = out_path)
ggsave("second-stage-grouped.png", second_stage_grouped, path = out_path)
ggsave("boxplot.png", boxplot, path = out_path)
